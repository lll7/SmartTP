/********************************************************************
 ...
 Hardware:		The code is natively intended to be used on the following
 				hardware platforms: PICDEMďż˝ FS USB Demo Board, 
 ...
 (the ďż˝Companyďż˝) for its PICďż˝ Microcontroller is intended and
 supplied to you, the Companyďż˝s customer, for use solely and
 ...
 THIS SOFTWARE IS PROVIDED IN AN ďż˝AS ISďż˝ CONDITION. NO WARRANTIES,
