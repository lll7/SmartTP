...
ROM BYTE configDescriptor1[]={
    ...
    0x01                        //Interval in ms.  4ms = up to 250Hz update rate.
};
...
ROM struct{BYTE report[HID_RPT01_SIZE];}hid_rpt01={
   ...
   // 0x09, 0x04,             //   USAGE (Stylus)
    ...
    0x09, 0x44, 			//     USAGE (Barrel Switch)             	//(byte[1] bit 4)
    ...
    //d 0x26, 0xCC, 0x16,       //     LOGICAL_MAXIMUM (32767)
